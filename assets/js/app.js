        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="card-text">
              ...
              <h5 id="cardprice">$${product.price}</h5>
            </div>
            <hr />
            <div id="btns">
  ...
  cartLogic() {
    ...
    cartContent.addEventListener("click", (event) => {
      if (event.target.classList.contains("remove-item")) {
        ...
        //call the "Storage" class, saveCart method and pass it in the new cart (updated cart)
        Storage.saveCart(cart);
        this.setCartValues(cart);
...
class Storage {
  ...
  //getting and saving the new cart values in the storage
  static saveCart(cart) {
    localStorage.setItem("cart", JSON.stringify(cart));
  }
  //taking info from the storage
  static getCart() {
